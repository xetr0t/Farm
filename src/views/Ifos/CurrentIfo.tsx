    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href="https://exchange.saltswap.finance/#/swap" mr="16px">
              {TranslateString(999, 'Buy cake')}
            </LinkExternal>
            <LinkExternal href="https://exchange.saltswap.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
          ...
          <Text as="div" pt="16px">
            <Button
              as="a"
              variant="secondary"
              href="https://docs.saltswap.finance/core-products/ifo-initial-farm-offering"
            >
